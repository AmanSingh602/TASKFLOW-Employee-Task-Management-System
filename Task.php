...
function count_pending_task($conn)
{
...
function count_in_progress_task($conn)
{
...
function count_completed_task($conn)
{
...
function count_my_pending_task($conn,$id)
{
...
function count_my_in_progress_task($conn,$id)
{
...
function count_my_completed_task($conn,$id)
{
