<?php
  ...
  if (isset($_SESSION["role"]) && isset($_SESSION["id"])) 
  {
	...
	{
		$all_task=count_tasks_due_today($conn);
		...
		$in_progress=count_in_progress_task($conn);
		...
		$in_progress=count_my_in_progress_task($conn,$_SESSION["id"]);
